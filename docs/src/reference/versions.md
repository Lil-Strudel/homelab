...
| Rook (operator + cluster) | `v1.20.7` | `core/controllers/rook-ceph/operator.yaml` + `core/configs/rook-ceph/cluster.yaml` |
| ceph-csi-drivers | `1.0.5` | `core/controllers/rook-ceph/csi-drivers.yaml` |
