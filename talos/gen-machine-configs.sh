...
# Control-plane nodes get the shared VIP patch (10.69.60.10) plus their per-node
# hostname patch. Patches apply in order, left to right.
talosctl machineconfig patch talos/controlplane.yaml --patch @machine-patches/controlplane-vip.yaml --patch @machine-patches/makima-1-patch.yaml --output machine-configs/makima-1.yaml
talosctl machineconfig patch talos/controlplane.yaml --patch @machine-patches/controlplane-vip.yaml --patch @machine-patches/makima-2-patch.yaml --output machine-configs/makima-2.yaml
talosctl machineconfig patch talos/controlplane.yaml --patch @machine-patches/controlplane-vip.yaml --patch @machine-patches/makima-3-patch.yaml --output machine-configs/makima-3.yaml
